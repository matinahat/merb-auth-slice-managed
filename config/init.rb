#
# ==== Standalone MerbAuthSliceAdministrable configuration
# 
...
require(File.join(File.expand_path(File.dirname(__FILE__)),"..","lib","merb-auth-slice-administrable"))

# Setup the required configuration for the slice
Merb::Slices::config[:merb_auth_slice_administrable][:from_email]        = "homer@example.com"
Merb::Slices::config[:merb_auth_slice_administrable][:host]   = "example.com"
...
Merb::BootLoader.before_app_loads do
  ...
  class User
    ...
    include Merb::Authentication::Mixins::AdministrableUser
